...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-mini"><b>Arrow</b>Empire</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Front</b>end</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo ucfirst(Auth::user()->name); ?> - Web Developer
                  ...
                  @else
                              ...
                              <a class="dropdown-item" href="{{ route('logout') }}"
                                 onclick="event.preventDefault();
                                    ...
                                    <?php  echo ucfirst(Auth::user()->name);  ?> {{ __('Logout') }}
                              </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.addpost') }}">Add New Post</a></li>
            <li><a href="{{ route('post.create') }}">Edit / Delete Posts</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('admin.showcategory') }}">Edit / Delete Category</a></li>
          </ul>
        </li>
